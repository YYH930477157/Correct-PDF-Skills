...
| E1 explicit symbol repair | low | auto_fix | Apply only whitelisted mappings such as corrupted less-than-or-equal symbols to `<=`; unknown symbols remain review items. |
